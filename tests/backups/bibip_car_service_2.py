...
class CarService:
    ...
    def add_index(self, path: str, index):
        """ Добавляет новый индекс в файл """
        with open(path, "w") as f:
            index = sorted(index)
            json.dump(index, f)

    # Записывает данные в файл
    def write_data(self, path, obj):
        obj_json = obj.model_dump_json().ljust(500) + '\n'
    ...
    def add_model(self, model: Model) -> Model:
        ...
        for index in models_index:
            ...
            models_index.append([model.id, len(models_index) + 1])  # Добавляем новый индекс
            self.add_index(self.models_index_path, models_index)  # Перезапись индекса
            self.write_data(self.models_data_path, model)  # Запись данных в файл
    ...
    def add_car(self, car: Car) -> Car:
        ...
        # Если такого нет, добавляем пару "vin - номер строки"
            ...
            self.write_data(self.cars_data_path, car)  # Запись данных в файл
    ...
    # Обновить статус
    def update_status(self, vin: str, new_status: CarStatus) -> Car:
    ...
    def sell_car(self, sale: Sale) -> Car:
        ...
        for index in sales_index:
            ...
            self.write_data(self.sales_data_path, sale)  # Запись данных в файл
...
if __name__ == "__main__":
    ...
    #car_service.update_status('KNAGM4A77D5316538', 'sold')

    obj = {"vin":"123asd","model":7,"price":"9999.00","date_start":"2020-02-20T00:00:00","status":"sold"} 
